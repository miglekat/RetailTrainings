...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { Store_Adress: @training.Store_Adress, Store_Name: @training.Store_Name, Training_Room: @training.Training_Room } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { Store_Adress: @training.Store_Adress, Store_Name: @training.Store_Name, Training_Room: @training.Training_Room } }
